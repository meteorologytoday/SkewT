...
cape_graph_size = np.array([2.0, 12.0])
space = {
    'wspace': 2.0,
    'hspace': 1.8,
    'tspace': 2.0,
...
skew_ax.text(0.5, -0.08, r'CAPE integral [$\mathrm{J} \,\, \mathrm{kg}^{-1}$]', verticalalignment='top', horizontalalignment='center', fontsize=20, transform=skew_ax.transAxes)
...
if sounding is not None:
	...
	ax.plot(s_parcel_Tlogp_p10, s_logp, color='#ee00ee', linewidth=1)
